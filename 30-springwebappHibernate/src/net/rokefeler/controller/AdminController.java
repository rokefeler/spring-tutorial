...
public class AdminController {
	...
	public String showDelete(Model model, 
			@PathVariable("idAd") int id, RedirectAttributes ra){
	
		if(adminService.delete(id))
		{
			ra.addFlashAttribute("resultado","Registro fue Eliminado con exito"); 
		}
		else
			ra.addFlashAttribute("resultado","Operacion de Eliminacion FUe Ignorada"); 
		return "redirect:/admin"; //retornar una redireccion y ya no una vista
	}
}

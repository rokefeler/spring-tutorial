...
public class MainApp {
	public static void main(String[] args) {
		...
		try {
			...
			for(int i=1; i<=5; i++){
				admins.add(new Admin(i,"Owen " + i, "Alumno " + i, ts));
			}
			//Se agrega a Proposito Key 5 duplicado, por tanto no se registrara ningun Registro por ser Transaccional
			admins.add(new Admin(5,"Owen " + 5, "Alumno " + 5, ts));
			...
			System.out.println("Datos de Registros son: \n" + adminDao.findAll().toString());

...
import net.rokefeler.pojo.AdminRowMapper;
...
//											new AdminRowMapper()); 
	...
	public int[] saveAll(List<Admin> admins) {
		...
		String sql="Insert into Admin (idAd, nombre, cargo, fechacreacion) values (:idAd, :nombre, :cargo, :fechacreacion)";		
